...
gnbsims=10
	...
	do
		...
		do
			...
			#sed -i "/udmIpv4Address/c\  udmIpv4Address: \"10.$repmod.13.$nrfc\"" charts/oai-smf/values.yaml
			...
			do
                ...
                kubectl exec -it -n oai $gnbsimpod -- /bin/bash -c /gnbsim/bin/entrypoint.sh 
                { kubectl exec -n oai $gnbsimpod -- /bin/bash -c /gnbsim/bin/example > "tmplogs/gnsimLog-$gnbsimpod.txt" 2>&1; } & 
