...
void nrf_app::handle_register_nf_instance(
  ...
  auto wbegin = boost::chrono::high_resolution_clock::now();
  ...
  switch (type) {
    case NF_TYPE_AMF: {
        auto wbegin_amf = boost::chrono::high_resolution_clock::now();
        sn = std::make_shared<amf_profile>(m_event_sub);
        auto wend_amf = boost::chrono::high_resolution_clock::now();
        auto welapsed_amf = boost::chrono::duration_cast<boost::chrono::microseconds>(wend_amf-wbegin_amf);
        std::ofstream out("amfreg.txt");
        out << welapsed_amf;
        out.close();
    } break;

    case NF_TYPE_SMF: {
        auto wbegin_smf = boost::chrono::high_resolution_clock::now();
        sn = std::make_shared<smf_profile>(m_event_sub);
        auto wend_smf = boost::chrono::high_resolution_clock::now();
        auto welapsed_smf = boost::chrono::duration_cast<boost::chrono::microseconds>(wend_smf-wbegin_smf);
        std::ofstream out("smfreg.txt");
        out << welapsed_smf;
        out.close();
    } break;

    case NF_TYPE_UPF: {
        auto wbegin_upf = boost::chrono::high_resolution_clock::now();
        sn = std::make_shared<upf_profile>(m_event_sub);
        auto wend_upf = boost::chrono::high_resolution_clock::now();
        auto welapsed_upf = boost::chrono::duration_cast<boost::chrono::microseconds>(wend_upf-wbegin_upf);
        std::ofstream out("upfreg.txt");
        out << welapsed_upf;
        out.close();
    } break;

    case NF_TYPE_AUSF: {
        auto wbegin_ausf = boost::chrono::high_resolution_clock::now();
        sn = std::make_shared<ausf_profile>(m_event_sub);
        auto wend_ausf = boost::chrono::high_resolution_clock::now();
        auto welapsed_ausf = boost::chrono::duration_cast<boost::chrono::microseconds>(wend_ausf-wbegin_ausf);
        std::ofstream out("ausfreg.txt");
        out << welapsed_ausf;
        out.close();
    } break;

    case NF_TYPE_UDM: {
        auto wbegin_udm = boost::chrono::high_resolution_clock::now();
        sn = std::make_shared<udm_profile>(m_event_sub);
        auto wend_udm = boost::chrono::high_resolution_clock::now();
        auto welapsed_udm = boost::chrono::duration_cast<boost::chrono::microseconds>(wend_udm-wbegin_udm);
        std::ofstream out("udmreg.txt");
        out << welapsed_udm;
        out.close();
    } break;

    case NF_TYPE_UDR: {
        auto wbegin_udr = boost::chrono::high_resolution_clock::now();
        sn = std::make_shared<udr_profile>(m_event_sub);
        auto wend_udr = boost::chrono::high_resolution_clock::now();
        auto welapsed_udr = boost::chrono::duration_cast<boost::chrono::microseconds>(wend_udr-wbegin_udr);
        std::ofstream out("udrreg.txt");
        out << welapsed_udr;
        out.close();
    } break;
  ...
  if (api_conv::profile_api_to_nrf_profile(nf_profile, sn)) {
    ...
    auto wend = boost::chrono::high_resolution_clock::now();;
    auto welapsed = boost::chrono::duration_cast<boost::chrono::microseconds>(wend-wbegin);
    std::ofstream out("totregone.txt");
    out << welapsed;
    out.close();
}
